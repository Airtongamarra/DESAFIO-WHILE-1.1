...
/*1. Faça um algoritmo que receba 1 número e exiba no console a tabuada desse e dos
...
var num = parseInt(prompt("Insira um valor"))
var contador = 1

while (contador < 11) {
    console.log(num, "x", contador, "=", num * contador, num + 1, "x", contador, "=", (num + 1) * contador, num + 2, "x", contador, "=", (num + 2) * contador, num + 3, "x", contador, "=", (num + 3) * contador)
    contador++
}